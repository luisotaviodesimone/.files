...
3. Since I've not yet discovered how to put the configuration files into the newly create NixOS machine, you'll to copy the configuration files from this directory to the `/etc/nixos` directory in the remote machine (do not forget the `hardware-configuration.nix` files)
